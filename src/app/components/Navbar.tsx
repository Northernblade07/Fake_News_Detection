    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <Link href="/" className="relative inline-flex items-center gap-2">
          <span className="h-3 w-3 rounded-full bg-gradient-to-r from-sky-400 via-sky-500 to-amber-400 shadow-[0_0_24px_rgba(56,189,248,0.45)]" />
        ...
        <nav className="relative hidden items-center gap-6 md:flex">
          ...
          <span ref={underlineRef} className="pointer-events-none absolute -bottom-1 left-0 block h-0.5 w-0 rounded-full bg-gradient-to-r from-sky-400 via-sky-500 to-amber-400" />
        </nav>

        <div className="flex items-center gap-4">
          <LanguageSwitcher />
          <div className="hidden items-center gap-2 md:flex">
            <Link href="/auth/login" className="rounded-md border border-white/10 bg-[#0f1524] px-3 py-1.5 text-sm text-slate-100 hover:border-sky-400/30 hover:bg-[#111a2f] transition">
              {t("login")}
            </Link>
            <Link href="/auth/register" className="rounded-md bg-gradient-to-r from-sky-400 via-sky-500 to-amber-400 px-3 py-1.5 text-sm font-semibold text-[#0b0f1a] shadow-[0_6px_24px_rgba(56,189,248,0.25)] hover:brightness-110 transition">
              {t("register")}
            </Link>
          </div>
        </div>
